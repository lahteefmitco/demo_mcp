...
class PeriodIncomesCubit extends Cubit<PeriodExpensesState> {
  PeriodIncomesCubit({required FinanceRepository repository})
  ...
  static Future<List<FinanceEntry>> _load(
    ...
    return repository.listIncomesLocalInDateRange(
      fromInclusive: from,
      toInclusive: to,
