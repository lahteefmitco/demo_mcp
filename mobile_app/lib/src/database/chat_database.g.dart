...
class $ChatSessionsTable extends ChatSessions
  ...
  @override
  List<GeneratedColumn> get $columns => [id, model, createdAt];
  @override
  ...
  VerificationContext validateIntegrity(
    Insertable<ChatSessionData> instance, {
...
class ChatSessionData extends DataClass implements Insertable<ChatSessionData> {
  ...
  factory ChatSessionData.fromJson(
  ...
  ChatSessionData copyWith({int? id, String? model, DateTime? createdAt}) =>
      ChatSessionData(
        id: id ?? this.id,
  ...
  @override
  int get hashCode => Object.hash(id, model, createdAt);
  @override
...
final class $$ChatSessionsTableReferences
    extends
        BaseReferences<_$ChatDatabase, $ChatSessionsTable, ChatSessionData> {
...
class $$ChatSessionsTableTableManager
    extends
        RootTableManager<
          ...
          (ChatSessionData, $$ChatSessionsTableReferences),
          ChatSessionData,
...
final class $$ChatMessagesTableReferences
    extends
        BaseReferences<_$ChatDatabase, $ChatMessagesTable, ChatMessageData> {
